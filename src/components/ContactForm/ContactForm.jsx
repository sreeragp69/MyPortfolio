    ...
    <form className="w-full flex flex-col items-cente lg:items-start justify-center gap-7 mt-9 lg:mt-0">
      <div className="w-full gap-8 lg:gap-4 flex justify-between flex-col lg:flex-row items-center">
        <div className="w-full">
          <input
            className="rounded-full w-full bg-gray outline-none text-white placeholder:text-white px-5 py-2.5"
            type="text"
            name="email"
      ...
      <div className="w-full">
        <textarea
          rows={6}
          className="w-full rounded-3xl bg-gray outline-none text-white placeholder:text-white px-5 py-2.5"
          name="message"
