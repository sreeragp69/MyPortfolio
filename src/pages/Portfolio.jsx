...
const Portfolio = () => {
  const myWorks = [
    ...
    
    {
      ...
      image: "logo-room.png",
      about: "Logo Room",
      techs: "React.js, Tailwind CSS, Vite, ShadCN UI, Radix UI, Lucide Icons, html2canvas",
    ...
    },
    {
      ...
      about: "Media Player",
      techs: "React.js, Bootstrap, React Router, Axios, React Toastify, UUID, React Feather",
    ...
    },
    {
      ...
      image: "notes-app.png",
      about: "Notes App",
      techs: "React.js, Tailwind CSS, React Router, Axios, JWT, Express.js, MongoDB, Mongoose, Node.js ",
        ...
        <div className="modal   fixed inset-0 flex justify-center items-center bg-gray-800 bg-opacity-50">
          <div className="modal-content w-[90%] md:w-1/2 flex flex-col items-center bg-mid-gray p-6 rounded-lg">
            ...
            <div className="mb-4  w-full gap-5 text-sm  ">
              ...
              <div className="flex items-start mt-1  justify-around  font-light flex-co md:flex-row text-white">
                <p className="flex items-center mb-2 md:mb-0 justify-between w-[14%]">
                  Preview:
                </p>
                <Link
            ...
            <button
              onClick={closeModal}
              className="mt-4 text-white  border px-4 rounded-sm"
            >
              Close
            </button>
          </div>
